...
encoder_outputs, state_h, state_c = keras.layers.LSTM(latent_dim, return_state=True)(encoder_inputs)
...
input_seq = encoder_input_data[6:7]
decoded_sentence = decode_sequence(input_seq)
print("-")
print("Input sentence:", input_texts[6])
